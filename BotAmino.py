...
class BotAmino(Command, Client, TimeOut, BannedWords):
    def __init__(self, email: str = None, password: str = None, sid: str = None, secret: str = None, deviceId: str = None, proxies: str = {'http://': 'socks5://ved:8080@premium.zaicadiahost.xyz:7875', 'https://':'socks5://ved:8080@premium.zaicadiahost.xyz:7875'}, certificatePath: str = None):
